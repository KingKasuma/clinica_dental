class ProsthesesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prosthesis.save
        format.html { redirect_to @prosthesis, notice: 'Prosthesis was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @prosthesis.update(prosthesis_params)
        format.html { redirect_to @prosthesis, notice: 'Prosthesis was successfully updated.' }
  ...
  def destroy
    @prosthesis.destroy
    respond_to do |format|
      format.html { redirect_to prostheses_url, notice: 'Prosthesis was successfully destroyed.' }
  ...
  private
    ...
    def prosthesis_params
      params.require(:prosthesis).permit(:nombre, :protesis, :costo, :treatment_id, :medical_history_id)
    end
end
