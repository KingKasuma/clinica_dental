...
ActiveRecord::Schema.define(version: 20170825100704) do
  ...
  add_index "account_books", ["sucursal_id"], name: "index_account_books_on_sucursal_id", using: :btree
  ...
  add_foreign_key "account_books", "sucursals"
